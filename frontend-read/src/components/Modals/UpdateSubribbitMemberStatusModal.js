...
function UpdateSubribbitMemberStatusModal(props) {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(
      updateSubribbitMemberAction(
        parseInt(props.member.userId),
        parseInt(status),
        parseInt(props.subribbit.id)
      )
    );
  };
  ...
  return (
    <Modal {...props} size="sm" aria-labelledby="contained-modal-title-vcenter">
      ...
      <Modal.Body>
        <small>
          Update status of member {GetUsername(props.member.username)}
        </small>
      ...
      <Modal.Footer>
        <Button onClick={props.onHide} id="updateSubribbitMemberButtonCancel">
          Cancel
        </Button>
        <Button onClick={submitHandler} id="updateSubribbitMemberButtonConfirm">
          Confirm
        </Button>
      </Modal.Footer>
    </Modal>
