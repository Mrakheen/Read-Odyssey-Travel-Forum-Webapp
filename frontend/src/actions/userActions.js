...
export const googleSignin =
  (name, email, password, imageURL) => async (dispatch) => {
    // For future purposes: username made by google sign in will be change with username: name + signedbygoogle
    const googleUsername = name + "signedbygoogle";
    ...
    try {
      ...
      const { data } = await axios.post(
        backendUrl + "api/auth/login/",
        { username: googleUsername, password: password },
        config
      );
