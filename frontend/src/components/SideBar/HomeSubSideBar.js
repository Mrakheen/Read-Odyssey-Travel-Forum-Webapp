    ...
    return (
        <Card className="p-4 rounded" id="subribbitSideBarSize">
            ...
            <div class="row pt-3 ps-3" id="subribbitSidebarDescription">
                ...
                <div>r/home is the default community of Redyssey. Click on <b><Link to="/explore" id="homeSubSideBarExploreLink">Search Post</Link></b> button on the navigation bar to explore posts from various communities.</div>
                <br /> <br />
            </div>
